...
const projects = [
  ...
  },
  {
    ...
    description:
      'My full-stack blog platform powered by Gemini API. Where l can write, edit, and get AI-assisted content suggestions in real time.',
    image: '/projects/project2.png',
    tags: ['React', 'TailwindCSS', 'Node'],
    demoUrl: 'https://en-blog-five.vercel.app',
    githubUrl: '#',
  },
  {
    id: 3,
  ...
  {
    id: 4,
    title: 'UniCirlce-Coming Soon',
    description:
      'My first Full Stack P2P platform for students to help each in money transfer',
    image: '/projects/project4.png',
    tags: ['React', 'Node', 'Stripe', 'TailwindCSS'],
    demoUrl: 'https://zim-connect.vercel.app',
    githubUrl: 'https://github.com/EBESYtheCoder/ZimConnect',
  },
];
